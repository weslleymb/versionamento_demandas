CREATE OR REPLACE PROCEDURE `sp.prc_load_tb_abrangencia675634`(VAR_PRJ_RAW STRING, VAR_PRJ_TRUSTED STRING)
BEGIN
    ...
    BEGIN
        ...
        ) AS origem_percentual_ideal_hub""";
